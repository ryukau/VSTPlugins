...
Following plugins are experimental, or in α stage. They lacks character and/or parameter tuning. Breaking changes might be introduced.
...
- UltraSynth
  - Naive synthesizer with 64-fold oversampling.
