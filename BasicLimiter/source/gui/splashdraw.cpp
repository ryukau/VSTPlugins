...
void CreditView::draw(CDrawContext *pContext)
{
  ...
  pContext->drawString("- Shift + Left Drag:", CPoint(20.0f, 100.0f));
  pContext->drawString("    Fine Adjustment", CPoint(20.0f, 120.0f));
  pContext->drawString("- Ctrl + Left Click:", CPoint(20.0f, 140.0f));
  pContext->drawString("    Reset to Default", CPoint(20.0f, 160.0f));

  pContext->drawString("This is an experimental plugin.", CPoint(20.0f, 190.0f));
  pContext->drawString("Do not use in production!", CPoint(20.0f, 210.0f));
