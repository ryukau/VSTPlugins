...
protected:
  ...
  int32_t defaultWidth = int32_t(2 * uiMargin + 2 * labelX - margin);
  int32_t defaultHeight = int32_t(2 * uiMargin + 7 * labelY);
  ...
  void setDimensions() override
  {
    ...
    defaultWidth = int32_t(2 * uiMargin + 2 * labelX - margin);
    defaultHeight = int32_t(2 * uiMargin + 7 * labelY);
